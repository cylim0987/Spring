...
//		System.out.println("memberList.get(1).getTeam().getName()->" + memberList.get(0).getTeam().getName());
	...
	public String memberUpdate(Member member, Model model) {
		...
		System.out.println("MemberController memberUpdate member.Teamname->" + member.getTeamname());
